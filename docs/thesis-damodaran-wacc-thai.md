# กรอบการลงทุนเชิงคุณค่าด้วย Reverse DCF บนตลาดหลักทรัพย์ไทย (SET) โดยใช้แบบจำลอง WACC ตามแนวทาง Damodaran

## บทคัดย่อ (Abstract)

วิทยานิพนธ์ฉบับนี้ศึกษาว่า **กรอบการลงทุนเชิงคุณค่าแบบย้อนกลับ (Reverse DCF)** ซึ่งใช้ **แบบจำลองต้นทุนทุนเฉลี่ยถ่วงน้ำหนัก (WACC)** ตามแนวทางของ Professor Aswath Damodaran สามารถคัดเลือกหุ้นในตลาดหลักทรัพย์ไทย (SET) ที่ให้ผลตอบแทนเหนือตลาด (Active Return) ได้หรือไม่ โดยใช้ข้อมูลย้อนหลังของหุ้น SET100 จำนวน 100 ตัว ในช่วงปี 2021-2026 และทำการปรับพอร์ตการลงทุนทุกไตรมาส
...
3. [ระMethodology](#3-ระmethodology-วิธีดำเนินการวิจัย)
4. [สถานการณ์ทดสอบ](#4-สถานการณ์ทดสอบ-test-scenarios)
5. [ผลการวิจัย](#5-ผลการวิจัย-results)
6. [การวิเคราะห์ผล](#6-การวิเคราะห์ผล-analysis)
7. [ข้อสรุป](#7-ข้อสรุป-conclusion)
8. [บรรณานุกรม](#8-บรรณานุกรม-references)
...
## 2. ทฤษฎีและวรรณกรรมที่เกี่ยวข้อง (Literature Review)
...
## 3. ระMethodology (วิธีดำเนินการวิจัย)
...
### 3.6 Default Spread (ICR-based)

ดูรายละเอียดใน Section 3.2.2

### 3.7 ROIC Quality Screen (EVA)
...
### 3.8 สถิติการทดสอบ (Backtest Design)
...
### 4.2 Scenario 1: damodaran_cds — Dynamic ERP (CDS-based)
...
### 4.3 Scenario 2: damodaran_rating — Dynamic ERP (Rating-based)
...
### 4.4 Scenario 3: damodaran_size — Size Premium Adjusted
...
### 4.5 Scenario 4: damodaran_beta — Bottom-up Beta Refined
...
### 4.6 Scenario 5: damodaran_full — Full Comprehensive (Conservative ERP)
...
### 4.7 Scenario 6: damodaran_full_cds — Full Comprehensive (CDS ERP) ⭐ BEST
...
### 4.8 Scenario 7: damodaran_roic — ROIC Quality Screen (EVA)
...
### 5.1 ตาราง Active Return (Quarterly Average)
...
### 5.2 ผลตอบแทนสะสม 5 ปี (Compounded PnL)
...
### 5.3 ผลปีต่อปี (damodaran_full_cds — Best Scenario)
...
### 5.5 การเปรียบเทียบกับ Benchmark (SET Index)
...
### 6.2 วิเคราะห์ผลกระทบของแต่ละ Factor
...
### 6.3 เปรียบเทียบกับ Baseline (Fixed 8% WACC)
